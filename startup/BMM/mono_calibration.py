...
def calibrate_high_end(mono='111', focus=False):
    ...
    def main_plan():
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Data/Staff/mono_calibration/cal.ini', folder=BMMuser.DATA, filename='ptcal', element='Pt', sample='Pt foil')
        close_last_plot()
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Data/Staff/mono_calibration/cal.ini', folder=BMMuser.DATA, filename='aucal', element='Au', sample='Au foil')
        close_last_plot()
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Data/Staff/mono_calibration/cal.ini', folder=BMMuser.DATA, filename='pbcal', element='Pb', sample='Pb foil')
        close_last_plot()
