...
def calibrate_low_end(mono='111', focus=False):
    ...
    def main_plan(focus):
        ...
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='fecal', element='Fe', sample='Fe foil', comment=f'calibrating Si{mono}')
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='cocal', element='Co', sample='Co foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='nical', element='Ni', sample='Ni foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='cucal', element='Cu', sample='Cu foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='zncal', element='Zn', sample='Zn foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
...
def calibrate_high_end(mono='111', focus=False):
    ...
    def main_plan(focus):
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='ptcal', element='Pt', edge='L3', sample='Pt foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='aucal', element='Au', edge='L3', sample='Au foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='pbcal', element='Pb', edge='L3', sample='Pb foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='nbcal', element='Nb', sample='Nb foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
        ...
        pitch = dcm_pitch.user_readback.get()
        yield from xafs('/home/xf06bm/Workspace/mono_calibration/cal.ini', folder=BMMuser.folder, filename='mocal', element='Mo', sample='Mo foil', comment=f'calibrating Si{mono}')
        kafka_message({'close': 'last'})
