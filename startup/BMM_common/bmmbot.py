...
pass_api = "https://api-dev.nsls2.bnl.gov/v1/proposal/{pass_id}/slack-channels"
...
class BMMbot():
    ...
    def post(self, text):
        ...
        if self._post_allowed is False:
            print('No proposal Slack channel exists.')
            return
        try:
    ...
    def refresh_channel(self):
        ...
        self.api_url = pass_api.format(pass_id=self.pass_id)
